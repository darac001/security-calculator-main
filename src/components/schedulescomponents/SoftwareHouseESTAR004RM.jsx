    ...
    <>
      ...
      <table id="my-table" className="w-1/2 text-sm text-left text-gray-800 ">
        ...
        <tbody className="text-[12px]">
          ...
          <Reader reader={reader} n="2" wiegand="RM-4 (1) WG1" />
          <Reader reader={reader} n="3" wiegand="RM-4 (2) WG1" />
          <tr className="px-2  text-left h-2 border border-[#e2e2e2]">
            <th
              scope="col"
              colSpan={7}
          ...
          <Input input={input} n="8" inp="RM-4 (1) IN1" />
          <Input input={input} n="9" inp="RM-4 (1) IN2" />
          <Input input={input} n="10" inp="RM-4 (2) IN1" />
          <Input input={input} n="11" inp="RM-4 (2) IN2" />
          ...
          <Output output={output} n="4" outp="RM-4 (1) OUT1" /> 
          <Output output={output} n="5" outp="RM-4 (1) OUT2" /> 
          <Output output={output} n="6" outp="RM-4 (2) OUT1" /> 
          <Output output={output} n="7" outp="RM-4 (2) OUT2" /> 
        </tbody>
      </table>
    </>
  );
...
export default SoftwareHouseESTAR004RM
