...
const SoftwareHouseI8 = ({ reader, input, output,acpName,setAcpName }) => {
  ...
  return (
    ...
    <div className="flex w-1/2">
      ...
      <div className="flex items-center w-1/2  px-2">
        <p className="text-[12px] font-bold mr-2">RS-485 PORT/ADDRESS:</p>
        <input
          type="text"
          id="acp_address"
          name="acp_address"
          value={acpName.acp_address}
          onChange={handleInputChange}
          // placeholder="ACP Name"
          className="w-[150px] mb-1 py-1 px-4 text-[12px] border border-[#e2e2e2] placeholder-gray-400 "
        />       
...
export default SoftwareHouseI8;
